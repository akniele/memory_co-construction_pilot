...
def save_annotation(user_folder, index, data, annotations_list, relation_spans):
    ...
    with open(filepath, "w") as file:
        ...
        annotation_data["Relations"] = {i:relation_spans[i-1] for i in range(1, len(relation_spans)+1)}
